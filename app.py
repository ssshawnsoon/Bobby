...
with st.container():
    ...
    st.write("Upload CV Analysis Report(s) geand Provide Job Description")

    uploaded_cvs = st.file_uploader("Upload CV Analysis Report(s) Generated by JOBBY for BOBBY to analyze and compare", type="pdf", accept_multiple_files=True)
