...
# --- Upload multiple CVs ---
with st.container():
    st.header("📄 Upload CVs Analysis Report Generated by JOBBY for BOBBY to Conduct Comparison")

    uploaded_cvs = st.file_uploader("Upload CV Analysis Report(s)", type="pdf", accept_multiple_files=True)
